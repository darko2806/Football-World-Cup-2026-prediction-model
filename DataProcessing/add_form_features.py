...
# =========================
# 1. Ucitavanje postojeceg finalnog dataseta
# =========================
...
# =========================
# 2. Long format: jedan red po timu po utakmici, sa poenima W=1/D=0/L=-1
# =========================
...
# =========================
# 3. Rolling forma po timu, racunata SAMO iz prethodnih utakmica (shift(1))
# =========================
...
# =========================
# 4. Spajanje forme nazad na home/away stranu originalnog dataseta
# =========================
...
# =========================
# 5. Razlike formi (home - away), za Eksperiment 2-7 do 2-12
# =========================
...
# =========================
# 6. Snimanje u poseban fajl (originalni dataset ostaje netaknut)
# =========================
